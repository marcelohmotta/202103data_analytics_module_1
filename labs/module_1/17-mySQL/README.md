...
Use pen and paper to create the design, take a picture with your phone and send the image to yourself. If you use software to create the database diagram, export in the image format (JPG or PNG). Either way, the image will be submitted as one of the deliverables using the format **your_name_challenge_1**.
...
You'll be using the `INSERT INTO` statement for this purpose. A tutorial you can refer to can be fine 
[here](https://dev.mysql.com/doc/refman/8.0/en/insert.html).
...
## Deliverables to be added in the **challenge output folder**
